namespace GreenCarCare
{
    partial class DataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.CntGreen = new System.Data.OleDb.OleDbConnection();
            ...
            this.DSGreen = new GreenCarCare.GreenDataSet();
            ...
            this.oleDbSelectCommand1.Connection = this.CntGreen;
            // 
            // CntGreen
            // 
            this.CntGreen.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Temp\\Green.mdb";
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `EQUIPMENT` (`Description`) VALUES (?)";
            this.oleDbInsertCommand1.Connection = this.CntGreen;
            ...
            this.oleDbUpdateCommand1.Connection = this.CntGreen;
            ...
            this.oleDbDeleteCommand1.Connection = this.CntGreen;
            ...
            this.oleDbUpdateCommand2.Connection = this.CntGreen;
            ...
            this.oleDbDeleteCommand2.Connection = this.CntGreen;
            ...
            this.oleDbUpdateCommand3.Connection = this.CntGreen;
            ...
            this.oleDbDeleteCommand3.Connection = this.CntGreen;
            ...
            this.oleDbUpdateCommand5.Connection = this.CntGreen;
            ...
            this.oleDbDeleteCommand5.CommandText = "DELETE FROM `SERVICETYPEEQUIPMENT` WHERE ((`ServiceTypeID` = ?) AND (`EquipmentID" +
                "` = ?))";
            this.oleDbDeleteCommand5.Connection = this.CntGreen;
            ...
            this.oleDbSelectCommand6.CommandText = "SELECT        VehicleID, PlateNumber, Make, Model, OwnerID\r\nFROM            VEHIC" +
                "LE\r\nORDER BY VehicleID";
            this.oleDbSelectCommand6.Connection = this.CntGreen;
            // 
            // oleDbInsertCommand6
            // 
            this.oleDbInsertCommand6.CommandText = "INSERT INTO `VEHICLE` (`PlateNumber`, `Make`, `Model`, `OwnerID`) VALUES (?, ?, ?" +
                ", ?)";
            this.oleDbInsertCommand6.Connection = this.CntGreen;
            ...
            this.oleDbUpdateCommand6.Connection = this.CntGreen;
            ...
            this.oleDbDeleteCommand6.Connection = this.CntGreen;
            ...
            this.oleDbDeleteCommand4.CommandText = "DELETE FROM `SERVICETYPE` WHERE ((`ServiceTypeID` = ?) AND ((? = 1 AND `Descripti" +
                ...
                "HourlyRate` = ?)))";
            this.oleDbDeleteCommand4.Connection = this.CntGreen;
            ...
            this.oleDbUpdateCommand4.Connection = this.CntGreen;
            ...
            this.oleDbInsertCommand4.Connection = this.CntGreen;
            ...
            this.oleDbSelectCommand4.Connection = this.CntGreen;
            // 
            // daServiceType
            // 
        ...
        private System.Data.OleDb.OleDbConnection CntGreen;
